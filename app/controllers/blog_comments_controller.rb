class BlogCommentsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to blog_blog_comment_path, notice: 'Blog comment was successfully destroyed.' }
  ...
  private
    ...
    def blog_comment_params
      params.require(:blog_comment).permit(:title, :author, :content, :published_date, :rating, :blog_id)
    end
end
